...
const UseNativeAccount = () => {
    ...
    const updateCache = react_1.useCallback(account => {
        ...
        if (wallet && wallet.publicKey) {
            const wrapped = wrapNativeAccount((_a = wallet.publicKey) === null || _a === void 0 ? void 0 : _a.toBase58(), account);
            if (wrapped !== undefined && wallet) {
                const id = (_b = wallet.publicKey) === null || _b === void 0 ? void 0 : _b.toBase58();
...
function AccountsProvider({ children = null }) {
    ...
    const walletKey = (_a = wallet === null || wallet === void 0 ? void 0 : wallet.publicKey) === null || _a === void 0 ? void 0 : _a.toBase58();
